...
"""
course_templates documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'course_templates',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edly/course_templates",
...
#
# html_title = 'course_templates v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Use for creating custom course templates.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'course_templates'),
                os.path.join(root_path, 'course_templates/migrations')])
