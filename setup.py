#!/usr/bin/env python
"""
Package metadata for course_templates.
"""
import os
import re
import sys
...
VERSION = get_version('course_templates', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""Use for creating custom course templates.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/edly/course_templates',
    packages=find_packages(
        include=['course_templates', 'course_templates.*'],
        exclude=["*tests"],
    ),
