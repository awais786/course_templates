...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint course_templates tests test_utils *.py
	rm tests/__init__.py
	pycodestyle course_templates tests  *.py
	pydocstyle course_templates tests *.py
	isort --check-only --diff tests test_utils course_templates *.py test_settings.py
